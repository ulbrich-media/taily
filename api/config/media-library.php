...
return [
    ...
    // Disabled, since we do all conversions synchronously during upload, at least for now
     ...
     * Our custom generator produces temporary signed route URLs for all private media.
     */
